...
# dataset.td_prob=0 dataset.role_n_congruence=0 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/6wp68dnn
# dataset.td_prob=0 dataset.role_n_congruence=0.5 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/1scqx6ya
# dataset.td_prob=0 dataset.role_n_congruence=1 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/pfq1xma0

# dataset.td_prob=0.5 dataset.role_n_congruence=0 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/hcv8c8lu
# dataset.td_prob=0.5 dataset.role_n_congruence=0.5 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/u4rf4nbw
# dataset.td_prob=0.5 dataset.role_n_congruence=1 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/cxuud4eg

# dataset.td_prob=1 dataset.role_n_congruence=0 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/a1ulm0zh
# dataset.td_prob=1 dataset.role_n_congruence=0.5 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/oqclfmfe
# dataset.td_prob=1 dataset.role_n_congruence=1 dataset.n_back=5
# python3 -m workingmem --wandb.run_sweep --wandb.sweep_id aloxatel/wm-comp-limit-7.3.1/4y7je0eo