...
3. **use with Weights and Biases (recommended)**
    ...
    once you make an account, log in to W&B via the CLI: 
    [`wandb login`](https://docs.wandb.ai/models/ref/cli/wandb-login).
